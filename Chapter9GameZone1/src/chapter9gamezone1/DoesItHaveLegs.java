		...
		while(true)
		{
			try
			{
				...
				else if(data.equalsIgnoreCase("I give up what is it?"))
				{
					...
					System.out.printf(
							"What is a question where the answer "
									+ "is yes for %s and no for %s.",
							newAnimal, currentNode.getDataType());
			...
			default:
				...
				else
				{
					...
					currentNode.getRight().getRight().getRight()
							.setRight("Yay! I W" + "in! " + "Lets Play Again.");
					currentNode.getRight().getRight().getLeft()
							.setLeft("I give up w" + "hat" + " is it?");
